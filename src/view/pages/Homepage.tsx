    ...
    return (
        <>
            ...
            <section id="homepage" className="flex h-full">
                ...
                {/* Items left */}
                <div className="flex-1 flex justify-center flex-col px-3">
                    ...
                    <p className="text-developerGreen leading-7 text-base
                                       md:text-xl md:leading-9 md:text-developerBlue ">
                ...
                {/* Items right */}
                <div className="flex-1 hidden justify-center gap-4 flex-col relative items-center md:flex m-4">
